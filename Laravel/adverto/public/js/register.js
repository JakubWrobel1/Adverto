$(document).ready(function() {
  ...
  function validateUsername() {
    ...
    if (usernameValue === '') {
      ...
      $('#usernameError').text('Nazwa użytkownika nie może zaczynać się od cyfry');
    } else {
      $('#usernameError').text('');
    }
  }
  ...
  function validatePassword() {
    ...
    if (passwordValue === '') {
      ...
      $('#passwordError').text('Hasło musi zawierać co najmniej jedną małą literę, jedną dużą literę i jedną cyfrę');
    } else {
      $('#passwordError').text('');
    }
  }
