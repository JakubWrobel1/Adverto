        ...
        <div class="md:focus:ring-0 md:w-auto w-screen flex-col items-center p-10">
            ...
            <form id="advertisementForm" action="/ogloszenia" method="POST" class="" enctype="multipart/form-data">
                ...
                <div class="mb-4 bg-white p-8 rounded-md">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" class="w-8/12 {{ $errors->has('title') ? 'border-b-2 border-red-500 border-x-0 border-t-0' : 'border-transparent' }} rounded px-4 py-2 mb-8 bg-[#f2f4f5]" placeholder="np. Galaxy S23 jak nówka..."><br>
