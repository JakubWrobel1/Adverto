...
@section('content')
    ...
    <div class="flex justify-center pt-5 mb-32 md:p-6 bg-[#f2f4f5] ">
        <div class="bg-white w-screen md:w-1/4 h-80 flex flex-col items-center  border-2  justify-center md:rounded-lg">
            <div class="p-2">
                <p>Imię: {{ $user->name }}</p>
            </div>
